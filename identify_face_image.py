...
# img_path= '../train_img/Shahrukh Khan/ActiOn_1.jpg'
        ...
        if (c % timeF == 0):
            ...
            if nrof_faces > 0:
                ...
                for i in range(nrof_faces):
                    ...
                    data = {"nom":nom,"prenom":prenom,"dette":M.gation_ID(M.gation_index('\"%s\"'%(nom), 'Nom'), 'Dette'),"tauxAlcool":M.gation_ID(M.gation_index('\"%s\"'%(nom), 'Nom'), 'tauxAlcool')}
