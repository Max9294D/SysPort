                    ...
                    if not os.path.exists(output_filename):
                        try:
                            ...
                            if nrof_faces > 0:
                                ...
                                scaled_temp = np.array(Image.fromarray(cropped_temp).resize((image_size, image_size), Image.BILINEAR)).astype(np.double)
                                # scaled_temp = imageio.imresize(cropped_temp, (image_size, image_size), interp='bilinear')
